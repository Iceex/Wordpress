 ...
 * @since 1.0.0
 */
class Technocy_Elementor_Products_Tabs extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Products Tabs', 'technocy');
    }
    ...
    public function get_script_depends() {
        return ['technocy-elementor-product-tab', 'slick'];
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            'tab_title',
            [
                'label'       => esc_html__('Tab Title', 'technocy'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('#Product Tab', 'technocy'),
                'placeholder' => esc_html__('Product Tab Title', 'technocy'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => [
                    [
                        'tab_title' => esc_html__('#Product Tab 1', 'technocy'),
                    ],
                    [
                        'tab_title' => esc_html__('#Product Tab 2', 'technocy'),
                    ]
                ],
        ...
        $this->start_controls_section(
            'section_product',
            [
                'label' => esc_html__('Product', 'technocy'),
            ]
        );
        $this->add_responsive_control(
            'product_gutter',
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Header', 'technocy'),
        ...
        $this->add_responsive_control(
            'align_items',
            [
                'label'       => esc_html__('Align', 'technocy'),
        ...
        $this->add_responsive_control(
            'header_margin',
            [
                'label'      => esc_html__('Spacing Between Item', 'technocy'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}}.products-tabs-style-technocy-yes .elementor-tab-title' => 'padding-left: calc( {{SIZE}}{{UNIT}}/2 ); padding-right: calc( {{SIZE}}{{UNIT}}/2 ); margin:0',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default'      => '',
                'prefix_class' => 'products-tabs-style-technocy-',
            ]
        );
            ...
            <div class="elementor-tabs-wrapper">
                ...
                <div class="elementor-tabs-wrapper-inner"><?php } ?>
                    ...
                    foreach ($tabs as $index => $item) :
                        ...
                        ?>
                        <div <?php echo technocy_elementor_get_render_attribute_string($tab_title_setting_key, $this); // WPCS: XSS ok.
                        ?>><?php echo esc_html($item['tab_title']); ?></div>
                    <?php endforeach; ?>
                    <?php if ($setting['products_tabs_style_theme'] === 'yes') { ?></div><?php } ?>
            </div>
            <div <?php echo technocy_elementor_get_render_attribute_string('data-carousel', $this); // WPCS: XSS ok.
            ?>>
                <?php
                foreach ($tabs as $index => $item) :
                    $tab_count = $index + 1;
...
$widgets_manager->register(new Technocy_Elementor_Products_Tabs());
