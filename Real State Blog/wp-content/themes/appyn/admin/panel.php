    ...
    <div class="pttbox">
    	<form method="post" id="form-panel">
            ...
            <div class="section" data-section="edcgp">
				...
				<table class="table-main tmnb">
					<tr>
						<td colspan="2"><?php echo __( 'Crea una API de Google Drive y coloca el ID de cliente y código secreto en los siguientes campos.', 'appyn' ); ?> <?php echo sprintf( __( 'Siga el %s para crear la API.', 'appyn' ), '<a href="'.$url.'" target="_blank">'. __( 'Tutorial', 'appyn' ). '</a>' ); ?></td>
					</tr>
					<tr>
				...
				<table class="table-main tmnb">
					<tr>
						<td colspan="2"><?php echo __( 'Crea una app en Dropbox y coloca el app key y app secret en los siguientes campos.', 'appyn' ); ?> <?php echo sprintf( __( 'Siga el %s.', 'appyn' ), '<a href="'.$url.'" target="_blank">'.__( 'tutorial', 'appyn' ). '</a>' ); ?></td>
					</tr>
					<tr>
				...
				<h2><?php echo __( 'FTP', 'appyn' ); ?></h2>
				<?php
				$url = ( lang_wp() == "es" ) ? 'https://themespixel.net/crear-app-de-dropbox-para-almacenamiento-de-archivos/' : 'https://themespixel.net/en/create-dropbox-app-for-file-storage/';
				?>
				<table class="table-main tmnb">
					<tr>
						<td colspan="2"><?php echo __( '¿Tienes un servidor externo? Realiza la conexión vía FTP para que los archivos importados sea subido a su propio servidor.', 'appyn' ); ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<div style="font-style:italic">/public-html/<br>
						/website.com/<br>
				...
				<h2><?php echo __( '1Fichier', 'appyn' ); ?></h2>
				<?php
				...
				<table class="table-main tmnb">
					<tr>
						<td colspan="2"><?php echo __( 'Genera una API Key en 1Fichier', 'appyn' ); ?>. <?php echo sprintf( __( 'Siga el %s.', 'appyn' ), '<a href="'.$url.'" target="_blank">'.__( 'tutorial', 'appyn' ). '</a>' ); ?></td>
					</tr>
					<tr>
				...
				<h2><?php echo __( 'OneDrive', 'appyn' ); ?></h2>
				<?php
				...
				<table class="table-main tmnb">
					<tr>
						<td colspan="2"><?php echo __( 'Crea una app en OneDrive', 'appyn' ); ?>. <?php echo sprintf( __( 'Siga el %s.', 'appyn' ), '<a href="'.$url.'" target="_blank">'.__( 'tutorial', 'appyn' ). '</a>' ); ?></td>
					</tr>
					<tr>
						<td><h3><?php echo __( 'ID de cliente', 'appyn' ); ?>*</h3></td>
            ...
            <div class="section" data-section="color">
				...
				<table class="table-main">
					...
					<tr>
						...
						<td><?php $color_theme_principal = appyn_options( 'color_theme_principal' );
