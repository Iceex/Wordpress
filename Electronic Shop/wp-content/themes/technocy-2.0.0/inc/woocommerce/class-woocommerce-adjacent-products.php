<?php
/**
 * Technocy WooCommerce Adjacent Products Class
 *
 * @package  technocy
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Technocy_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Technocy WooCommerce Adjacent Products Class
	 */
	class Technocy_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'technocy_woocommerce_adjacent_query_args', $args ) );
