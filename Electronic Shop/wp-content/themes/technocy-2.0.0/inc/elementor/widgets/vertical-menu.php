...
class Technocy_Elementor_Vertiacl_Menu extends Elementor\Widget_Base {

    protected $nav_menu_index = 1;

    public function get_name() {
        return 'technocy-vertiacl-menu';
    }

    public function get_title() {
        return esc_html__('Technocy Vertical Menu', 'technocy');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'nav_vertiacl_layout',
            [
                'label'        => esc_html__('Menu Layout', 'technocy'),
                'type'         => Controls_Manager::SELECT,
                'options'      => [
                    'style-1' => esc_html__('Dropdown', 'technocy'),
                    'style-2' => esc_html__('Navbar', 'technocy'),
                ],
                'default'      => 'style-1',
...
//            'nav_vertiacl_style',
//            [
//                'label'   => esc_html__('Menu Style', 'technocy'),
//                'type'    => Controls_Manager::SELECT,
//                'options' => [
...
//        );
        ...
        $this->add_responsive_control(
            'icon_menu_size',
            [
                'label'     => esc_html__('Size Icon', 'technocy'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Sub Menu', 'technocy'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        $this->add_group_control(
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Icon Color Hover', 'technocy'),
                'type'      => Controls_Manager::COLOR,
                'default'   => '',
                'selectors' => [
...
//        $this->add_render_attribute('wrapper', 'class', 'style-' . esc_attr($settings['nav_vertiacl_style']));
        ...
        <div <?php echo technocy_elementor_get_render_attribute_string('wrapper', $this); ?>>
            <?php
            ?>
            <nav class="vertical-navigation" aria-label="<?php esc_attr_e('Vertiacl Navigation', 'technocy'); ?>">
...
$widgets_manager->register(new Technocy_Elementor_Vertiacl_Menu());
