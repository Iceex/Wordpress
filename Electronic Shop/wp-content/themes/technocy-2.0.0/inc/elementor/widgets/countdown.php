...
class Technocy_Elementor_Countdown extends Elementor\Widget_Base {

    public function get_name() {
        return 'technocy-countdown';
    }

    public function get_title() {
        return esc_html__('technocy Countdown', 'technocy');
    }
    ...
    public function get_script_depends() {
        return ['technocy-elementor-countdown'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_countdown',
            [
                'label' => esc_html__('Countdown', 'technocy'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options'      => [
                    ...
                    'style-5' => esc_html__('Style 5', 'technocy'),
                    'style-6' => esc_html__('Style 6', 'technocy'),
                ],
                'default'      => 'style-1',
        ...
        $this->add_control(
            'due_date',
            [
                'label'       => esc_html__('Due Date', 'technocy'),
                'type'        => Controls_Manager::DATE_TIME,
                'default'     => date('Y-m-d H:i', strtotime('+1 month') + (get_option('gmt_offset') * HOUR_IN_SECONDS)),
                /* translators: %s: Time zone. */
                'description' => sprintf(esc_html__('Date set according to your timezone: %s.', 'technocy'), Utils::get_timezone_string()),
            ]
        );
        ...
        $this->add_control(
            'show_days',
            [
                'label'     => esc_html__('Days', 'technocy'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'technocy'),
                'label_off' => esc_html__('Hide', 'technocy'),
                'default'   => 'yes',
            ]
        );
        ...
        $this->add_control(
            'show_hours',
            [
                'label'     => esc_html__('Hours', 'technocy'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'technocy'),
                'label_off' => esc_html__('Hide', 'technocy'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'show_minutes',
            [
                'label'     => esc_html__('Minutes', 'technocy'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'technocy'),
                'label_off' => esc_html__('Hide', 'technocy'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'show_seconds',
            [
                'label'     => esc_html__('Seconds', 'technocy'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'technocy'),
                'label_off' => esc_html__('Hide', 'technocy'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'show_labels',
            [
                'label'     => esc_html__('Show Label', 'technocy'),
                'type'      => Controls_Manager::SWITCHER,
                'label_on'  => esc_html__('Show', 'technocy'),
                'label_off' => esc_html__('Hide', 'technocy'),
                'default'   => 'yes',
        ...
        $this->add_control(
            'custom_labels',
            [
                'label'     => esc_html__('Custom Label', 'technocy'),
                'type'      => Controls_Manager::SWITCHER,
                'condition' => [
                    'show_labels!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default'     => esc_html__('Days', 'technocy'),
                'placeholder' => esc_html__('Days', 'technocy'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_days'      => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Hours', 'technocy'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Hours', 'technocy'),
                'placeholder' => esc_html__('Hours', 'technocy'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_hours'     => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Minutes', 'technocy'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Minutes', 'technocy'),
                'placeholder' => esc_html__('Minutes', 'technocy'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_minutes'   => 'yes',
        ...
        $this->add_control(
            ...
            [
                'label'       => esc_html__('Seconds', 'technocy'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Seconds', 'technocy'),
                'placeholder' => esc_html__('Seconds', 'technocy'),
                'condition'   => [
                    'show_labels!'   => '',
                    'custom_labels!' => '',
                    'show_seconds'   => 'yes',
        ...
        $this->start_controls_section(
            'section_box_style',
            [
                'label' => esc_html__('Boxes', 'technocy'),
        ...
        $this->add_responsive_control(
            'container_width',
            [
                'label'      => esc_html__('Container Width', 'technocy'),
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .elementor-technocy-countdown' => 'max-width: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            'items_width',
            [
                'label'      => esc_html__('Items Width', 'technocy'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            'items_height',
            [
                'label'      => esc_html__('Items Height', 'technocy'),
                'type'       => Controls_Manager::SLIDER,
                'range'      => [
                    'px' => [
                        'min' => 0,
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors'  => [
                    ...
                    '{{WRAPPER}}.elementor-widget-technocy-countdown .elementor-countdown-item:before' => 'right: -{{RIGHT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'default'   => 'center',
                'selectors' => [
                    '{{WRAPPER}} .elementor-technocy-countdown' => 'justify-content: {{VALUE}}',
                ],
            ]
        );
        ...
        $this->add_control(
            'digits_color',
            [
                'label'     => esc_html__('Color digit', 'technocy'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'digits_color_2',
            [
                'label'       => esc_html__('Bg Color digit', 'technocy'),
                'type'        => Controls_Manager::COLOR,
                'selectors'   => [
                ...
                'description' => esc_html__('Background Or Border Color', 'technocy'),
            ]
        );
        ...
        $this->add_responsive_control(
            'digits_padding',
            [
                'label'      => esc_html__('Padding digits', 'technocy'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
        ...
        $this->add_responsive_control(
            'digits_margin',
            [
                'label'      => esc_html__('Margin digits', 'technocy'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'selectors'  => [
        ...
        $this->add_control(
            'heading_label',
            [
                'label'     => esc_html__('Label', 'technocy'),
        ...
        $this->add_control(
            'label_color',
            [
                'label'     => esc_html__('Color label', 'technocy'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'decor_color',
            [
                'label'     => esc_html__('Color decor', 'technocy'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
    ...
    private function _init_default_countdown_labels() {
        $this->_default_countdown_labels = [
            'label_months'  => esc_html__('Months', 'technocy'),
            'label_weeks'   => esc_html__('Weeks', 'technocy'),
            'label_days'    => esc_html__('Days', 'technocy'),
            'label_hours'   => esc_html__('Hours', 'technocy'),
            'label_minutes' => esc_html__('Minutes', 'technocy'),
            'label_seconds' => esc_html__('Seconds', 'technocy'),
        ];
    }
    ...
    protected function render() {
        ...
        ?>
        <div class="elementor-technocy-countdown" data-date="<?php echo esc_attr($due_date); ?>">
            <?php echo technocy_elementor_get_strftime($instance, $this); // WPCS: XSS ok. ?>
        </div>
        <?php
    }
}

$widgets_manager->register(new Technocy_Elementor_Countdown());
