    ...
    function quick_product_variable() {
        ...
        $(document).on('click', btnSelector, function (e) {
            ...
            if ($product.hasClass('quick-shop-loaded')) {
                ...
                $('body').trigger('technocy-quick-view-displayed');
                return;
            }
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    // technocyThemeModule.swatchesVariations();
            ...
            // Ajax action.
            xhr = $.ajax({
                url: wc_add_to_cart_params.wc_ajax_url.toString().replace('%%endpoint%%', 'technocy_add_to_cart'),
                data: formData,
                type: 'POST',
                processData: false,
                contentType: false,
