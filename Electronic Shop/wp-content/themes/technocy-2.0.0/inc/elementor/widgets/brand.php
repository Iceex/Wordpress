 ...
 * @since 1.0.0
 */
class Technocy_Elementor_Brand extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Brands', 'technocy');
    }
    ...
    public function get_script_depends() {
        return ['technocy-elementor-brand', 'slick'];
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            'section_brands',
            [
                'label' => esc_html__('Brands', 'technocy'),
            ]
        );
        ...
        $repeater->add_control(
            'brand_title',
            [
                'label'       => esc_html__('Brand name', 'technocy'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Brand Name', 'technocy'),
                'placeholder' => esc_html__('Brand Name', 'technocy'),
                'label_block' => true,
            ]
        );
        ...
        $this->add_control(
            'border_style',
            [
                'label'        => esc_html__('Border', 'technocy'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => '',
                'prefix_class' => 'technocy-brand-border-'
            ]
        );
                        ...
                        <div <?php echo technocy_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                            <div class="elementor-brand-image">
                                ...
                                if (!empty($item['link'])) {
                                    ...
                                    echo '<a href="' . esc_url($item['link']['url'] ? $item['link']['url'] : '#') . '" ' . technocy_elementor_get_render_attribute_string('brand-image', $this) . ' title="' . esc_attr($item['brand_title']) . '">';
                                }
...
$widgets_manager->register(new Technocy_Elementor_Brand());
