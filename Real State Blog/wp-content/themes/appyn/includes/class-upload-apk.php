...
class UploadAPK {
    ...
    public function __construct( $post_id, $idps, $apk, $update, $range, $total_parts, $part = 0 ) {
    ...
    public function uploadFile() {
        ...
        if( $this->checkAPK_OBB() ) {
            ...
            wp_remote_get( $this->temp_file, $args);
    ...
    private function uploadToWP() {
        ...
        return array( 'url' => $this->uploaddir['url'] . '/' . $this->filename_original );
