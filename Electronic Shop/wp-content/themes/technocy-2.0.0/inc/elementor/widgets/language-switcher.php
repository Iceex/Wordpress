 ...
 * @since 1.0.0
 */
class Technocy_Elementor_Language_Switcher extends Elementor\Widget_Base {
    ...
    public function get_name() {
        return 'technocy-language-switcher';
    }
    ...
    public function get_title() {
        return esc_html__('Language Switcher', 'technocy');
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                'name'     => 'typography',
                'selector' => '{{WRAPPER}} .technocy-language-switcher span.title',
            ]
        );
        ...
        $this->add_control(
            'label_color',
            [
                'label'     => esc_html__('Label Color', 'technocy'),
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .technocy-language-switcher .item > div i' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            'hover_right',
            [
                'label'        => esc_html__('Hover Right', 'technocy'),
    ...
    protected function render() {
        technocy_language_switcher();
    }
}

$widgets_manager->register(new Technocy_Elementor_Language_Switcher());
