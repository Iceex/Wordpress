<?php
$theme          = wp_get_theme('technocy');
$technocy_version = $theme['Version'];
...
$technocy = (object)array(
    'version' => $technocy_version,
    /**
...
if (technocy_is_woocommerce_activated()) {
    $technocy->woocommerce = require get_theme_file_path('inc/woocommerce/class-woocommerce.php');
...
if (technocy_is_elementor_activated()) {
    ...
    $technocy->elementor = require get_theme_file_path('inc/elementor/class-elementor.php');
    $technocy->megamenu  = require get_theme_file_path('inc/megamenu/megamenu.php');
    $technocy->parallax  = require get_theme_file_path('inc/elementor/section-parallax.php');
