...
/**
 * Class Technocy_Elementor_Blog
 */
class Technocy_Elementor_Post_Grid extends Elementor\Widget_Base {

    public function get_name() {
        return 'technocy-post-grid';
    }

    public function get_title() {
        return esc_html__('Posts Grid', 'technocy');
    }
    ...
    public function get_script_depends() {
        return ['technocy-elementor-posts-grid', 'slick'];
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_query',
            [
                'label' => esc_html__('Query', 'technocy'),
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'post_date',
                'options' => [
                    'post_date'  => esc_html__('Date', 'technocy'),
                    'post_title' => esc_html__('Title', 'technocy'),
        ...
        $this->add_control(
            ...
            [
                ...
                'type'    => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'post-style-1' => esc_html__('Style 1', 'technocy'),
                    'post-style-2' => esc_html__('Style 2', 'technocy'),
                ],
        ...
        $this->start_controls_section(
            'post_style_content',
            [
                'label' => esc_html__( 'Post', 'technocy' ),
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .post-style-1 .entry-header' => 'background: {{VALUE}};',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .post-style-1 .entry-header' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
                    '{{WRAPPER}} .post-style-1 .entry-header' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .post-style-1 .entry-header' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->start_controls_section(
            'section_pagination',
            [
                'label' => esc_html__('Pagination', 'technocy'),
            ]
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    ...
                    'numbers'               => esc_html__('Numbers', 'technocy'),
                    'prev_next'             => esc_html__('Previous/Next', 'technocy'),
                    'numbers_and_prev_next' => esc_html__('Numbers', 'technocy') . ' + ' . esc_html__('Previous/Next', 'technocy'),
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Page Limit', 'technocy'),
                'default'   => '5',
                'condition' => [
                    'pagination_type!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Shorten', 'technocy'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Previous Label', 'technocy'),
                'default'   => esc_html__('&laquo; Previous', 'technocy'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Next Label', 'technocy'),
                'default'   => esc_html__('Next &raquo;', 'technocy'),
                'condition' => [
                    'pagination_type' => [
                        'prev_next',
                        'numbers_and_prev_next',
    ...
    protected function render_loop_footer() {
        ...
        if ($has_numbers) {
            $links = paginate_links([
                ...
                'before_page_number' => '<span class="elementor-screen-only">' . esc_html__('Page', 'technocy') . '</span>',
            ]);
        }
        ...
        <div class="pagination">
            <nav class="elementor-pagination" role="navigation"
                 aria-label="<?php esc_attr_e('Pagination', 'technocy'); ?>">
...
$widgets_manager->register(new Technocy_Elementor_Post_Grid());
