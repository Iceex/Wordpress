...
if (!technocy_is_mailchimp_activated()) {
    return;
}
...
class Technocy_Elementor_Mailchimp extends Elementor\Widget_Base {

    public function get_name() {
        return 'technocy-mailchmip';
    }

    public function get_title() {
        return esc_html__('MailChimp Sign-Up Form', 'technocy');
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Input', 'technocy'),
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Color Placeholder', 'technocy'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_tab(
            'tab_input_focus',
            [
                'label' => esc_html__('Focus', 'technocy'),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Icon Border Color hover', 'technocy'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
...
$widgets_manager->register(new Technocy_Elementor_Mailchimp());
