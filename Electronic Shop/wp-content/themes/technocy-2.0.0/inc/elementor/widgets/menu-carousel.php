...
class Technocy_Elementor_Menu_Carousel extends Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Technocy Menu Carousel', 'technocy');
    }
    ...
    {
        return ['technocy-elementor-menu-carousel', 'slick'];
    }
    ...
    protected function register_controls()
    {
        ...
        $repeater->add_control(
            'target_link',
            [
                'label' => esc_html__('Target', 'technocy'),
                'default' => 'yes',
...
$widgets_manager->register(new Technocy_Elementor_Menu_Carousel());
