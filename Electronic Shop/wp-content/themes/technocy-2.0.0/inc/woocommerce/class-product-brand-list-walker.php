<?php
/**
 * Technocy_Product_Brand_List_Walker class
 *
 * @extends    Walker
 * @class        Technocy_Product_Brand_List_Walker
 * @version        2.3.0
...
if (!class_exists('Technocy_Product_Brand_List_Walker', false)) :

	class Technocy_Product_Brand_List_Walker extends Walker {
