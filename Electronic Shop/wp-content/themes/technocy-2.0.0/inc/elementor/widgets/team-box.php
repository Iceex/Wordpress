...
class Technocy_Elementor_Team_Box extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Team Box', 'technocy');
    }
    ...
    protected function register_controls() {
        $this->start_controls_section(
            'section_team',
            [
                'label' => esc_html__('Team', 'technocy'),
            ]
        );
        ...
        $this->add_control(
            'teams',
            [
                'label' => esc_html__('Team Item', 'technocy'),
        ...
        $this->add_control(
            'facebook',
            [
                'label'       => esc_html__('Facebook', 'technocy'),
                'placeholder' => esc_html__('https://www.facebook.com/opalwordpress', 'technocy'),
        ...
        $this->add_control(
            'twitter',
            [
                'label'       => esc_html__('Twitter', 'technocy'),
                'placeholder' => esc_html__('https://twitter.com/opalwordpress', 'technocy'),
        ...
        $this->add_control(
            'youtube',
            [
                'label'       => esc_html__('Youtube', 'technocy'),
                'placeholder' => esc_html__('https://www.youtube.com/user/WPOpalTheme', 'technocy'),
        ...
        $this->add_control(
            'google',
            [
                'label'       => esc_html__('Google', 'technocy'),
                'placeholder' => esc_html__('https://plus.google.com/u/0/+WPOpal', 'technocy'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Icon Social', 'technocy'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
                    ...
                    <?php if (!empty($settings[$key])) : ?>
                        <li class="social">
                            <a href="<?php echo esc_url($settings[$key]) ?>">
                                <i class="technocy-icon-<?php echo esc_attr($social); ?>"></i>
                            </a>
                        </li>
                    <?php endif; ?>
                <?php endforeach; ?>
...
$widgets_manager->register(new Technocy_Elementor_Team_Box());
