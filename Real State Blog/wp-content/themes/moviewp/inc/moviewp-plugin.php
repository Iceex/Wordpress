...
function moviewp_register_required_plugins() {
	...
	$plugins = array(
		array(
			...
			'source'             => 'https://moviewp.altervista.org/wp-content/extensions/moviewp-core.zip', // The plugin source.
		...
		array(
			...
			'source'             => 'https://moviewp.altervista.org/wp-content/extensions/custom-post-template.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
		...
		array(
			...
			'source'             => 'https://moviewp.altervista.org/wp-content/extensions/advanced-custom-fields-pro.zip', // The plugin source.
			'required'           => true, // If false, the plugin is only 'recommended' instead of required.
		...
		array(
			...
			'source'             => 'https://moviewp.altervista.org/wp-content/extensions/Importer.zip', // The plugin source.
