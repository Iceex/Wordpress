...
class Technocy_Call_To_Action extends Elementor\Widget_Base {

    public function get_name() {
        return 'technocy-banner';
    }
    public function get_categories() {
        return ['technocy-addons'];
    }
    public function get_title() {
        return esc_html__( 'Technocy Banner', 'technocy' );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__( 'Image Resolution', 'technocy' ),
                'default' => 'large',
                'condition' => [
                    'bg_image[id]!' => '',
                ],
        ...
        $this->add_control(
            'graphic_element',
            [
                'label' => esc_html__( 'Graphic Element', 'technocy' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'none' => [
                        'title' => esc_html__( 'None', 'technocy' ),
                        'icon' => 'eicon-ban',
                    ],
                    'image' => [
                        'title' => esc_html__( 'Image', 'technocy' ),
                        'icon' => 'fa fa-picture-o',
                    ],
                    'icon' => [
                        'title' => esc_html__( 'Icon', 'technocy' ),
                        'icon' => 'eicon-star',
                    ],
                ],
                'default' => 'none',
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'default' => esc_html__( 'Default', 'technocy' ),
                    'stacked' => esc_html__( 'Stacked', 'technocy' ),
                    'framed' => esc_html__( 'Framed', 'technocy' ),
                ],
                'default' => 'default',
                'condition' => [
                    'graphic_element' => 'icon',
        ...
        $this->add_control(
            'icon_shape',
            [
                'label' => esc_html__( 'Shape', 'technocy' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'circle' => esc_html__( 'Circle', 'technocy' ),
                    'square' => esc_html__( 'Square', 'technocy' ),
                ],
                'default' => 'circle',
                'condition' => [
                    'icon_view!' => 'default',
        ...
        $this->add_control(
            'subtitle',
            [
                'label' => esc_html__( 'Sub title', 'technocy' ),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => esc_html__( 'This is the sub title', 'technocy' ),
                'placeholder' => esc_html__( 'Enter your sub title', 'technocy' ),
                'label_block' => true,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'title',
            [
                'label' => esc_html__( 'Title & Description', 'technocy' ),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => esc_html__( 'This is the heading', 'technocy' ),
                'placeholder' => esc_html__( 'Enter your title', 'technocy' ),
                'label_block' => true,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => esc_html__( 'Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'technocy' ),
                'placeholder' => esc_html__( 'Enter your description', 'technocy' ),
                'separator' => 'none',
                'rows' => 5,
                'show_label' => false,
            ]
        ...
        $this->add_control(
            'title_tag',
            [
                'label' => esc_html__( 'Title HTML Tag', 'technocy' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'h1' => 'H1',
                    'h2' => 'H2',
        ...
        $this->add_control(
            'button',
            [
                'label' => esc_html__( 'Button Text', 'technocy' ),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
        ...
        $this->add_control(
            'link',
            [
                'label' => esc_html__( 'Link', 'technocy' ),
        ...
        $this->add_control(
            'link_click',
            [
                'label' => esc_html__( 'Apply Link On', 'technocy' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'box' => esc_html__( 'Whole Box', 'technocy' ),
                    'button' => esc_html__( 'Button Only', 'technocy' ),
                ],
                'default' => 'button',
                'separator' => 'none',
                'condition' => [
        ...
        $this->add_control(
            'content-stretch',
            [
                'label' => esc_html__( 'Stretch', 'technocy' ),
        ...
        $this->add_control(
            'vertical_position',
            [
                'label' => esc_html__( 'Vertical Position', 'technocy' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'top' => [
                    ...
                    'middle' => [
                        'title' => esc_html__( 'Middle', 'technocy' ),
        ...
        $this->add_control(
            'show_bg',
            [
                'label'     => esc_html__( 'Show Bg gradien', 'technocy' ),
                'type'      => Controls_Manager::SWITCHER,
                'selectors' => [
        ...
        $this->add_control(
            'graphic_image_hover',
            [
                'label' => esc_html__( 'Image Effect', 'technocy' ),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control(
            'icon_primary_color',
            [
                'label' => esc_html__( 'Primary Color', 'technocy' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Secondary Color', 'technocy' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'condition' => [
                    'graphic_element' => 'icon',
        ...
        $this->add_control(
            'icon_padding',
            [
                'label' => esc_html__( 'Icon Padding', 'technocy' ),
                'type' => Controls_Manager::SLIDER,
                'selectors' => [
        ...
        $this->add_responsive_control(
            'Horizontal_align',
            [
                'label' => esc_html__( 'Horizontal Align', 'technocy' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'flex-start' => [
                        'title' => esc_html__( 'Left', 'technocy' ),
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Subtitle', 'technocy' ),
                'separator' => 'before',
                'condition' => [
                    'subtitle!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'Background Hover', 'technocy' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::HEADING,
                'label' => esc_html__( 'Colors', 'technocy' ),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'subtitle_color',
            [
                'label' => esc_html__( 'Sub title Color', 'technocy' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'description_color',
            [
                'label' => esc_html__( 'Description Color', 'technocy' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'button_style',
            [
                'label' => esc_html__( 'Button', 'technocy' ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'button!' => '',
                ],
        ...
        $this->add_control(
            ...
            [
                'label'     => esc_html__('Icon Border Color', 'technocy'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'button_style_theme',
            [
                'label'        => esc_html__('Button Style', 'technocy'),
                'type'         => Controls_Manager::SWITCHER,
                'default'      => '',
        ...
        $this->start_controls_section(
            'hover_effects',
            [
                'label' => esc_html__( 'Hover Effects', 'technocy' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'transformation',
            [
                'label' => esc_html__( 'Hover Animation', 'technocy' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => 'None',
                    'zoom-in' => 'Zoom In',
        ...
        $this->add_control(
            'overlay_color',
            [
                'label' => esc_html__( 'Overlay Color', 'technocy' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'overlay_blend_mode',
            [
                'label' => esc_html__( 'Blend Mode', 'technocy' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    '' => esc_html__( 'Normal', 'technocy' ),
                    'multiply' => 'Multiply',
                    'screen' => 'Screen',
                    'overlay' => 'Overlay',
                    'darken' => 'Darken',
        ...
        $this->add_control(
            'effect_duration',
            [
                'label' => esc_html__( 'Transition Duration', 'technocy' ),
                'type' => Controls_Manager::SLIDER,
...
//        $content_animation = $settings['content_animation'];
        ...
        ?>
        <<?php echo esc_html($wrapper_tag) . ' ' . technocy_elementor_get_render_attribute_string( 'wrapper', $this ); ?> class="elementor-cta--skin-cover elementor-cta elementor-technocy-banner">
        <?php if ( $print_bg ) : ?>
            <div class="elementor-cta__bg-wrapper">
                <div class="elementor-cta__bg elementor-bg" <?php echo technocy_elementor_get_render_attribute_string( 'background_image', $this ); ?>></div>
        ...
        <?php if ( $print_content ) : ?>
            ...
            <?php if ( 'image' === $settings['graphic_element'] && ! empty( $settings['graphic_image']['url'] ) ) : ?>
                <div <?php echo technocy_elementor_get_render_attribute_string( 'graphic_element', $this ); ?>>
                ...
                <div <?php echo technocy_elementor_get_render_attribute_string( 'graphic_element', $this ); ?>>
                    <div class="elementor-icon">
                        <?php if ( $is_new || $migrated ) :
                            ...
                            <i <?php echo technocy_elementor_get_render_attribute_string( 'icon', $this ); ?>></i>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if ( ! empty( $settings['subtitle'] ) ) : ?>
                <div <?php echo technocy_elementor_get_render_attribute_string( 'subtitle', $this ); ?>>
                    <span><?php printf('%s', $settings['subtitle']); ?></span>
                </div>
            <?php endif; ?>

            <?php if ( ! empty( $settings['title'] ) ) : ?>
                <<?php echo esc_html($title_tag) . ' ' . technocy_elementor_get_render_attribute_string( 'title', $this ); ?>>
                <?php printf('%s', $settings['title']); ?>
                </<?php echo esc_html($title_tag); ?>>
            <?php endif; ?>

            <?php if ( ! empty( $settings['description'] ) ) : ?>
                <div <?php echo technocy_elementor_get_render_attribute_string( 'description', $this ); ?>>
            ...
            <div class="elementor-cta__button-wrapper elementor-cta__content-item elementor-content-item <?php echo esc_attr($animation_class); ?>">
                <<?php echo esc_html($button_tag) . ' ' . technocy_elementor_get_render_attribute_string( 'button', $this ); ?>>
                <span>
...
$widgets_manager->register(new Technocy_Call_To_Action());
