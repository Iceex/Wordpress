...
function url_eps_update() {
	...
	?>
	<script>
		var text_confirm_update = "<?php echo __( '¿Quiere actualizar la información de esta aplicación? Recuerda que reemplazará toda la información.', 'appyn' ).$am; ?>";
	</script>
<?php
}
...
function px_convert_post_old_version2($post_id){
	global $wpdb;
